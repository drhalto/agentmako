...
export interface BiomeDiagnosticsToolInput extends ProjectLocatorInput {
  files: string[];
  scriptName?: string;
  maxFindings?: number;
}

export const BiomeDiagnosticsToolInputSchema = ProjectLocatorInputObjectSchema.extend({
...
}).strict() satisfies z.ZodType<BiomeDiagnosticsToolInput>;

export interface BiomeDiagnosticsToolOutput {
...
export const BiomeDiagnosticsToolOutputSchema = z.object({
  toolName: z.literal("biome_diagnostics"),
...
}) satisfies z.ZodType<BiomeDiagnosticsToolOutput>;
