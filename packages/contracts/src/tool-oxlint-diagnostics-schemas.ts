...
export interface OxlintDiagnosticsToolInput extends ProjectLocatorInput {
  files: string[];
  scriptName?: string;
  maxFindings?: number;
}

export const OxlintDiagnosticsToolInputSchema = ProjectLocatorInputObjectSchema.extend({
...
}).strict() satisfies z.ZodType<OxlintDiagnosticsToolInput>;

export interface OxlintDiagnosticsToolOutput {
...
export const OxlintDiagnosticsToolOutputSchema = z.object({
  toolName: z.literal("oxlint_diagnostics"),
...
}) satisfies z.ZodType<OxlintDiagnosticsToolOutput>;
